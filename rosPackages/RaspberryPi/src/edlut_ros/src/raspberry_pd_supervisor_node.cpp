...
int main(int argc, char **argv)
{
  ...
  ros::NodeHandle nh;
	...
	std::string robot_state_topic, torque_topic;
  std::vector<double> kp;
	...
	private_node_handle_.getParam("robot_state_topic", robot_state_topic);
  ...
  private_node_handle_.getParam("joint_list", joint_list);
	...
	raspberry_PDSupervisor Supervisor(robot_state_topic,
		torque_topic,
		joint_list,
		kp,
		kd,
