...
int main(int argc, char **argv)
{
	...
	TorqueAddition_Delay_PD_Wifi objTorqueBuffer(wireless_simulation, cerebellar_torque_topic, pd_supervisor_torque_topic, output_topic, joint_list, past_cerebellar_torque_buffer_size,
