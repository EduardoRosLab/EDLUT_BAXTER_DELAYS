...
#ifndef TorqueAddition_Delay_H_
#define TorqueAddition_Delay_H_
...
public:
	 ...
	 */
	TorqueAddition_Delay(bool wireless_simulation,
std::string torque_cerebellum_topic_name,
	 ...
	 */
	virtual ~TorqueAddition_Delay();

};

#endif /* TorqueAddition_Delay_H_ */
