...
#ifndef ROSRBFBANK_COMPACTDELAY_H_
#define ROSRBFBANK_COMPACTDELAY_H_
...
public:
	 ...
	 */
	ROSRBFBank_compactDelay(std::vector<unsigned int> num_filters_row,
			ros::Publisher * publisher,
	 ...
	 */
	void GenerateActivity(std::vector<double> current_values, double cur_simulation_time, double new_sampling_period, double delayMsg);
	 ...
	 */
	virtual ~ROSRBFBank_compactDelay();
