/***************************************************************************
 *                  Q_TrajectoryController_compactDelay.h                  *
 *                           -------------------                           *
...
#ifndef Q_TRAJECTORYCONTROLLER_COMPACTDELAY_H_
#define Q_TRAJECTORYCONTROLLER_COMPACTDELAY_H_
 ...
 */
class Q_TrajectoryController_compactDelay {
...
public:
	 ...
	 */
	Q_TrajectoryController_compactDelay(std::vector<std::string> joint_list,
	 ...
	 */
	virtual ~Q_TrajectoryController_compactDelay();

};

#endif /* Q_TraJECTORYCONTROLLER_COMPACTDELAY_H_ */
