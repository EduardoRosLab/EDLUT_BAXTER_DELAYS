/***************************************************************************
 *                           Q_InterpolatorTrajectoryController.h          *
 *                           -------------------                           *
...
#ifndef Q_INTERPOLATORTRAJECTORYCONTROLLER_H_
#define Q_INTERPOLATORTRAJECTORYCONTROLLER_H_
 ...
 */
class Q_InterpolatorTrajectoryController {
...
public:
	 ...
	 */
	Q_InterpolatorTrajectoryController(std::vector<std::string> joint_list,
	 ...
	 */
	virtual ~Q_InterpolatorTrajectoryController();

};

#endif /* Q_INTERPOLATORTRAJECTORYCONTROLLER_H_ */
