...
#ifndef PDSUPERVISOR_NODELAY_H_
#define PDSUPERVISOR_NODELAY_H_
...
public:
	 ...
	 */
	PDSupervisor_noDelay(std::string current_position_topic,
	 ...
	 */
	virtual ~PDSupervisor_noDelay();

};

#endif /* PDSUPERVISO_NODELAY_H_ */
