/***************************************************************************
 *                   Q_TrajectoryControllerRandom_compactDelay.h           *
 *                           -------------------                           *
...
#ifndef Q_TRAJECTORYCONTROLLERRANDOM_COMPACTDELAY_H_
#define Q_TRAJECTORYCONTROLLERRANDOM_COMPACTDELAY_H_
 ...
 */
class Q_TrajectoryControllerRandom_compactDelay {
...
public:
	 ...
	 */
	Q_TrajectoryControllerRandom_compactDelay(std::vector<std::string> joint_list,
	 ...
	 */
	virtual ~Q_TrajectoryControllerRandom_compactDelay();

};

#endif /* Q_TraJECTORYCONTROLLERRANDOM_COMPACTDELAY_H_ */
