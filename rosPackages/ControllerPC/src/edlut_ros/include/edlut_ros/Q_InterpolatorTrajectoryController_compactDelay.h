/***************************************************************************
 *              Q_InterpolatorTrajectoryController_compactDelay.h          *
 *                           -------------------                           *
...
#ifndef Q_INTERPOLATORTRAJECTORYCONTROLLER_COMPACTDELAY_H_
#define Q_INTERPOLATORTRAJECTORYCONTROLLER_COMPACTDELAY_H_
 ...
 */
class Q_InterpolatorTrajectoryController_compactDelay {
...
public:
	 ...
	 */
	Q_InterpolatorTrajectoryController_compactDelay(std::vector<std::string> joint_list,
	 ...
	 */
	virtual ~Q_InterpolatorTrajectoryController_compactDelay();

};

#endif /* Q_INTERPOLATORTRAJECTORYCONTROLLER_COMPACTDELAY_H_ */
