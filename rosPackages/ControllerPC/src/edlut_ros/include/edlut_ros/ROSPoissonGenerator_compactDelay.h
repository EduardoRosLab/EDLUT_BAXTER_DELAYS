/***************************************************************************
 *                           ROSPoissonGenerator_compactDelay.h                         *
 *                           -------------------                           *
...
#ifndef ROSPOISSONGENERATOR_COMPACTDELAY_H_
#define ROSPOISSONGENERATOR_COMPACTDELAY_H_
 ...
 */
class ROSPoissonGenerator_compactDelay {
private:
	// ROS Node Handler
...
public:
	 ...
	 */
	ROSPoissonGenerator_compactDelay(std::vector<unsigned int> num_filters_row,
			std::vector<double> min_values,
			std::vector<double> max_values,
			std::vector<unsigned int> init_neuron,
			std::vector<unsigned int> end_neuron,
	...
	*/
	 ...
	 */
	void GenerateActivity(double input_signal_value, double current_time, int joint, double new_sampling_period, double delayMsg);
	//void GenerateActivity(std::vector<double> current_values, double current_time, int joint); //

	/*
	 * Destructor of the class
	 */
	virtual ~ROSPoissonGenerator_compactDelay();
