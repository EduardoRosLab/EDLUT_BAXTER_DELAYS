...
#include "edlut_ros/Q_TrajectoryController_compactDelay.h"
...
int Q_TrajectoryController_compactDelay::FindJointIndex(std::vector<std::string> strvector, std::string name){
...
void Q_TrajectoryController_compactDelay::MoveToStartingPoint(const bool & StopMovement){
...
void Q_TrajectoryController_compactDelay::LearningTrial(const bool & StopMovement){
...
Q_TrajectoryController_compactDelay::Q_TrajectoryController_compactDelay(std::vector<std::string> joint_list,
...
Q_TrajectoryController_compactDelay::~Q_TrajectoryController_compactDelay() {
 ...
 */
bool Q_TrajectoryController_compactDelay::NextControlStep(const bool & StopMovement){
