/***************************************************************************
 *              Q_InterpolatorTrajectoryController_compactDelay.cpp        *
 *                           -------------------                           *
...
int Q_InterpolatorTrajectoryController_compactDelay::FindJointIndex(std::vector<std::string> strvector, std::string name){
...
void Q_InterpolatorTrajectoryController_compactDelay::MoveToStartingPoint(const bool & StopMovement){
...
void Q_InterpolatorTrajectoryController_compactDelay::LearningTrial(const bool & StopMovement){
	...
	do {
		...
		edlut_ros::AnalogCompactDelay msgPosition;
		...
		edlut_ros::AnalogCompactDelay msgVelocity;
...
Q_InterpolatorTrajectoryController_compactDelay::Q_InterpolatorTrajectoryController_compactDelay(std::vector<std::string> joint_list,
			std::string desired_position_topic,
			std::string desired_velocity_topic,
			std::string control_topic,
			std::string joint_command_topic,
			Q_InterpolatorTrajectoryGenerator * trajectory_generator,
	...
	this->desired_position_pub = this->NodeHandler.advertise<edlut_ros::AnalogCompactDelay>(desired_position_topic, 10);
	ROS_DEBUG("Baxter Trajectory Controller: Advertised topic %s for desired position", desired_position_topic.c_str());
	this->desired_velocity_pub = this->NodeHandler.advertise<edlut_ros::AnalogCompactDelay>(desired_velocity_topic, 10);
...
Q_InterpolatorTrajectoryController_compactDelay::~Q_InterpolatorTrajectoryController_compactDelay() {
 ...
 */
bool Q_InterpolatorTrajectoryController_compactDelay::NextControlStep(const bool & StopMovement){
