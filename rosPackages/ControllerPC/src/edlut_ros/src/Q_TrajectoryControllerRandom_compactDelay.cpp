/***************************************************************************
 *                 Q_TrajectoryControllerRandom_compactDelay.cpp           *
 *                           -------------------                           *
...
#include "edlut_ros/Q_TrajectoryControllerRandom_compactDelay.h"
...
int Q_TrajectoryControllerRandom_compactDelay::FindJointIndex(std::vector<std::string> strvector, std::string name){
...
void Q_TrajectoryControllerRandom_compactDelay::MoveToStartingPoint(const bool & StopMovement){
...
void Q_TrajectoryControllerRandom_compactDelay::LearningTrial(const bool & StopMovement){
...
Q_TrajectoryControllerRandom_compactDelay::Q_TrajectoryControllerRandom_compactDelay(std::vector<std::string> joint_list,
...
Q_TrajectoryControllerRandom_compactDelay::~Q_TrajectoryControllerRandom_compactDelay() {
 ...
 */
bool Q_TrajectoryControllerRandom_compactDelay::NextControlStep(const bool & StopMovement){
