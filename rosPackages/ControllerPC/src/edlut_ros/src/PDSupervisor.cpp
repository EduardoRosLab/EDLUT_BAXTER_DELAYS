...
void PDSupervisor::CurrentPositionCallback(const edlut_ros::AnalogCompactDelay::ConstPtr& msg){
...
void PDSupervisor::CurrentVelocityCallback(const edlut_ros::AnalogCompactDelay::ConstPtr& msg){
	// Check if the message is newer than previous ones.
