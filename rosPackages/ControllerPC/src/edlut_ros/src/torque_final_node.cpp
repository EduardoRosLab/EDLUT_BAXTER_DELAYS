...
int main(int argc, char **argv)
{
	...
	std::string cerebellar_torque_topic, pd_supervisor_torque_topic, mean_torque_topic;
	...
	int backup_copy_size, min_filter_size;
	...
	private_node_handle_.getParam("min_filter_size", min_filter_size);
	...
	TorqueAddition objTorqueBuffer(cerebellar_torque_topic, pd_supervisor_torque_topic, output_topic, joint_list, past_cerebellar_torque_buffer_size,
																min_filter_size, T_iteration, iteration_samples, n_iterations_backup, disable_gravity_compensation, gravity_topic, &nh, &CallbackQueue);
