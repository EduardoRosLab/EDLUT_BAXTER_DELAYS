...
def create_network():
    ...
    networkfile = os.path.expanduser('~/.ros/data/Network_6_joints_10MF_per_RBF_4MF_per_GrC_100DCN.cfg')
    weightfile = os.path.expanduser('~/.ros/data/Weights_6_joints_10MF_per_RBF_4MF_per_GrC_100DCN.cfg')

    num_of_joints = 6

    num_mf_neurons_per_joint = 4*10
    ...
    num_pc_neurons_per_joint = 2*50
    num_io_neurons_per_joint = 2*50
    num_dcn_neurons_per_joint = 2*50
    ...
    grcpc_weights_fast = 1.6 #2.0 Max PC average firing: 279.61Hz
