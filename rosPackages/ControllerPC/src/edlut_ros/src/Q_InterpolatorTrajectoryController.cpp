/***************************************************************************
 *                           Q_InterpolatorTrajectoryController.cpp        *
 *                           -------------------                           *
...
#include "edlut_ros/Q_InterpolatorTrajectoryController.h"
...
int Q_InterpolatorTrajectoryController::FindJointIndex(std::vector<std::string> strvector, std::string name){
...
void Q_InterpolatorTrajectoryController::MoveToStartingPoint(const bool & StopMovement){
...
void Q_InterpolatorTrajectoryController::LearningTrial(const bool & StopMovement){
...
Q_InterpolatorTrajectoryController::Q_InterpolatorTrajectoryController(std::vector<std::string> joint_list,
...
Q_InterpolatorTrajectoryController::~Q_InterpolatorTrajectoryController() {
 ...
 */
bool Q_InterpolatorTrajectoryController::NextControlStep(const bool & StopMovement){
