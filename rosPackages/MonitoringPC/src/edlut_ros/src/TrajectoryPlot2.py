...
class TrajectoryAnimation(animation.TimedAnimation):
	...
	def new_figure(self):
		...
		self.axis.view_init(elev=90., azim=0)
		...
		self.line_ideal = Line3D([], [], [], color="magenta", linestyle='-', lw="2.0", label="desired trajectory")
		self.line_real = Line3D([], [], [], color="royalblue", linestyle='-', lw="2.0", label="performed trajectory")
