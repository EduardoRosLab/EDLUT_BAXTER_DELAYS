...
InternalSpike * LIFTimeDrivenModel_1_2_GPU_NEW::ProcessInputSpike(Interconnection * inter, double time){
...
bool LIFTimeDrivenModel_1_2_GPU_NEW::UpdateState(int index, double CurrentTime){
...
enum NeuronModelOutputActivityType LIFTimeDrivenModel_1_2_GPU_NEW::GetModelOutputActivityType(){
	return OUTPUT_SPIKE;
}

enum NeuronModelInputActivityType LIFTimeDrivenModel_1_2_GPU_NEW::GetModelInputActivityType(){
	return INPUT_SPIKE;
}
...
bool LIFTimeDrivenModel_1_2_GPU_NEW::CheckSynapseType(Interconnection * connection){
