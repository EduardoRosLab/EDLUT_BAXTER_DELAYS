...
void TimeDrivenPurkinjeCell_IP::LoadNeuronModel(string ConfigFile) throw (EDLUTFileException){
	FILE *fh;
	long Currentline = 0L;
...
void TimeDrivenPurkinjeCell_IP::LoadNeuronModel() throw (EDLUTFileException){
...
void TimeDrivenPurkinjeCell_IP::loadIntegrationMethod(string fileName, FILE *fh, long * Currentline)throw (EDLUTFileException){
