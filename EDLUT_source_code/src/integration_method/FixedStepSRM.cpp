...
FixedStepSRM::FixedStepSRM() : IntegrationMethod("FixedStepSRM"){
...
void FixedStepSRM::loadParameter(TimeDrivenNeuronModel * model, FILE *fh, long * Currentline, string fileName) throw (EDLUTFileException){
