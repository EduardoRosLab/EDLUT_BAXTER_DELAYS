/***************************************************************************
 *                           SinOptimisedBufferedWeightChange.h            *
 *                           -------------------                           *
...
#ifndef SINOPTIMISEDBUFFEREDWEIGHTCHANGE_H_
#define SINOPTIMISEDBUFFEREDWEIGHTCHANGE_H_

/*!
 * \file SinOptimisedBufferedWeightChange.h
 *
 ...
 * \date April 2016
 */ 
class SinOptimisedBufferedWeightChange: public AdditiveKernelChange{
	private:
	...
	public:
		 ...
		 */ 
		SinOptimisedBufferedWeightChange(int NewLearningRuleIndex);
		 ...
		 */
		virtual ~SinOptimisedBufferedWeightChange();
...
#endif /*SINOPTIMISEDBUFFEREDWEIGHTCHANGE_H_*/
