...
#ifndef LIFTIMEDRIVENMODEL_1_3_NEW_H_
#define LIFTIMEDRIVENMODEL_1_3_NEW_H_

/*!
 * \file LIFTimeDrivenModel_1_3_NEW.h
 *
 ...
 * This class is a redefinition of LIFTimeDrivenModel_1_3 neuron model using mV, ms, nS, mA and pF units.
 */
...
/*!
 * \class LIFTimeDrivenModel_1_3_NEW
 *
 ...
 * \date April 2018
 */
class LIFTimeDrivenModel_1_3_NEW : public TimeDrivenNeuronModel {
	protected:
		/*!
		...
		/*!
		* \brief Inverse membrane capacitance in 1/nF units
		*/
		float inv_cm;
	...
	public:
		...
		*/
		 ...
		 */
		LIFTimeDrivenModel_1_3_NEW(string NeuronTypeID, string NeuronModelID);
		 ...
		 */
		virtual ~LIFTimeDrivenModel_1_3_NEW();
...
#endif /* LIFTIMEDRIVENMODEL_1_3_NEW_H_ */
