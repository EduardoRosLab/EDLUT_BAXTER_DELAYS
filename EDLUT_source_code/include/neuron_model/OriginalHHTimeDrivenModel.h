...
#ifndef ORIGINALHHTIMEDRIVENMODEL_H_
#define ORIGINALHHTIMEDRIVENMODEL_H_
 ...
 * \date May 2015
 */
class OriginalHHTimeDrivenModel : public TimeDrivenNeuronModel {
	protected:

		/*!
		* \brief Excitatory reversal potential in mV
		*/
		float eexc;

		/*!
		* \brief Inhibitory reversal potential in mV
		*/
		float einh;

		/*!
		* \brief Resting potential in mV
		*/
		float erest;

		/*!
		* \brief Resting conductance in nS
		*/
		float grest;

		/*!
		* \brief Membrane capacitance in pF
		*/
		float cm;
		float inv_cm;

		/*!
		* \brief Virtual firing threshold in mV
		*/
		float vthr;

		/*!
		* \brief AMPA receptor time constant in ms
		*/
		float texc;
		float inv_texc;

		/*!
		* \brief GABA receptor time constant in ms
		*/
		float tinh;
		float inv_tinh;

		/*!
		* \brief Maximum value of sodium conductance in nS
		*/
		float gNa;

		/*!
		* \brief Maximum value of potasium conductance in nS
		*/
		float gKd;

		/*!
		* \brief Sodium potential in mV
		*/
		float ENa;

		/*!
		* \brief Potasium potential in mV
		*/
		float EK;

		/*!
		* \brief Efective threshold potential in mV
		*/
		float VT;
	...
	public:
		...
		*/
		 ...
		 */
		OriginalHHTimeDrivenModel(string NeuronTypeID, string NeuronModelID);
		 ...
		 */
		virtual ~OriginalHHTimeDrivenModel();
