 ...
 *
 * \brief Izhikevich Time-Driven neuron model with a membrane potential (v),a membrane recovery variable (u) and
 * two conductances.
 *
...
class IzhikevichTimeDrivenModel : public TimeDrivenNeuronModel {
	...
	public:
		...
		*/
		 ...
		 */
		IzhikevichTimeDrivenModel(string NeuronTypeID, string NeuronModelID);
