...
class TimeDrivenPurkinjeCell_IP : public TimeDrivenNeuronModel {
	protected:
		...
		*/
		...
		/*!
		 * \brief epsilon capacitance 
		 */
		float ep_Capacitance;
		...
		*/
		const float Membrane_capacitance_const;
		const float inv_Membrane_capacitance_const;
	...
	public:
		...
		*/
		 ...
		 */
		TimeDrivenPurkinjeCell_IP(string NeuronTypeID, string NeuronModelID);
