/***************************************************************************
 *                           IzhikevichTimeDrivenModel_GPU.h                  *
 *                           -------------------                           *
...
#ifndef IZHIKEVICHTIMEDRIVENMODEL_GPU_H_
#define IZHIKEVICHTIMEDRIVENMODEL_GPU_H_
 ...
 * \date May 2013
 */
class IzhikevichTimeDrivenModel_GPU : public TimeDrivenNeuronModel_GPU {
	protected:
		/*!
	...
	public:
		...
		*/
		 ...
		 */
		IzhikevichTimeDrivenModel_GPU(string NeuronTypeID, string NeuronModelID);
		 ...
		 */
		virtual ~IzhikevichTimeDrivenModel_GPU();
